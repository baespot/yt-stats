...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans overflow-x-hidden" style={{ background: 'var(--bg-base)', color: 'var(--text-primary)' }}>
      ...
      <footer style={{ textAlign: 'center', padding: '24px', fontSize: '11px', color: 'var(--text-tertiary)', borderTop: '1px solid var(--border-color)', marginTop: '40px', letterSpacing: '0.5px' }}>
